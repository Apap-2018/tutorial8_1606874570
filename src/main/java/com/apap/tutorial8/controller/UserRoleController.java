...
public class UserRoleController {
    ...
    private ModelAndView updatePass(@ModelAttribute PasswordModel pass, Model model, RedirectAttributes redirect) {
    	BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
		UserRoleModel user = userService.findUserByName(SecurityContextHolder.getContext().getAuthentication().getName());
		String msg = "";
